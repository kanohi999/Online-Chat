...
const SignUpPage = () => {
  ...
  const validateForm = () => {
    ...
    if (!formData.email.trim()) return toast.error("Электронная почта обязательна");
    ...
    if (formData.password.length < 6) return toast.error("Пароль должен состоять не менее чем из 6 символов");
  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2">
        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="text-center mb-8">
            <div className="flex flex-col items-center gap-2 group">
              ...
              <h1 className="text-2xl font-bold mt-2">Создай аккаунт</h1>
              <p className="text-base-content/60">Начни с регистрации бесплатного аккаунта</p>
            </div>
          </div>
      ...
      <AuthImagePattern
        title="Присоединяйся"
        subtitle="Обменивайся сообщениями в нашем мессенджере"
      />
    </div>
  );
};
